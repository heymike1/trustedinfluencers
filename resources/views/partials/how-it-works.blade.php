...
<div class="grid gap-4 md:grid-cols-3">
    <div class="card p-6 flex flex-col gap-4">
        ...
        <div class="mt-2 rounded-xl border border-ink-100 bg-ink-50 p-4 flex flex-col gap-2.5" aria-hidden="true">
            <span class="flex h-10 items-center rounded-full border border-ink-200 bg-white px-4 text-[13px] text-ink-900">youtube.com/@yourhandle<span class="ml-0.5 inline-block h-4 w-px bg-ink-900"></span></span>
    ...
    <div class="card p-6 flex flex-col gap-4">
        ...
        <div class="mt-2 rounded-xl border border-ink-100 bg-ink-50 p-4 flex flex-col gap-2.5" aria-hidden="true">
            <span class="flex h-10 items-center gap-2.5 rounded-full border border-ink-200 bg-white px-4 text-[13px] font-semibold text-ink-900"><x-platform-icon platform="youtube" class="size-4" :colored="true" /> Continue with YouTube</span>
